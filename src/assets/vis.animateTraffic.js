...
var $visNetworkAnimator =  (function () {

var init = function(visNetworkPrototype)
{
visNetworkPrototype.animateTraffic =
    ...
    var trafficAnimator = {
        ...
        parseEdgeTraffic : function (edgeTraffic) {
            ...
            if (edgeTraffic.edge)
            {
                ...
                if(!edge)
                {
                    console.log("lookingFor:'"+edgeTraffic.edge+"' did you forget to set the edge id?");
...
visNetworkPrototype.animateTrafficOnPostAnimation = function(edgesTrafficList) {
	// add the value from the source traffic to target
	for (var i in edgesTrafficList) {
		edgeTraffic = this.parseEdgeTraffic(edgesTrafficList[i]);
		if (!edgeTraffic.edge) {
...
visNetworkPrototype.animateTrafficOnPreAnimation = function(edgesTrafficList) {
	// remove the value from the source traffic
	for (var i in edgesTrafficList) {
		edgeTraffic = this.parseEdgeTraffic(edgesTrafficList[i]);
		if (!edgeTraffic.edge) {
